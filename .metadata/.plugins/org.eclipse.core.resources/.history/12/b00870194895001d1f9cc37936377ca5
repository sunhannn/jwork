...
public class UtilEx01 {
	...
	public static void main(String[] args) {
		...
		Arrays.sort(a); // 오름차순 정리 , collections.reverseOrder(); 내림차순 정리
		...
		System.out.println("52는 배열의 " + Arrays.binarySearch(a, 53) + "번 요소");
...
//		System.out.println();
		...
		System.out.println("배열 a와 배열b가 같은가 : " + Arrays.equals(a, b));
		System.out.println();

		int[] c = new int[5];
//		System.arraycopy(배열1, 배열1의복사시작번호, 배열2, 배열2의 복사시작번호, 복사길이);
