...
public class WrapEx02 {
	...
	public static void main(String[] args) {
		...
		System.out.println("객체 주소 해시코드값: " + System.identityHashCode(s));//달라요
		System.out.println("객체 주소 해시코드값: " + System.identityHashCode(t));//달라요
		System.out.println("데이터의 해시코드값: " + s.hashCode());//같아요
		System.out.println("데이터의 해시코드값: " + t.hashCode());//같아요
